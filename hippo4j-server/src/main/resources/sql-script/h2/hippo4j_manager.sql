...
CREATE TABLE IF NOT EXISTS `his_config_verify`  (
   ...
   `mark` varchar(128)  COMMENT '框架线程池类型',
   `tenant_id` varchar(128)  COMMENT '租户ID',
   `item_id` varchar(128)  COMMENT '项目ID',
   `tp_id` varchar(256)  COMMENT '线程池ID',
   `identify` varchar(64)  COMMENT '线程池唯一标识',
   ...
   `verify_user` varchar(128)  COMMENT '审核人',
